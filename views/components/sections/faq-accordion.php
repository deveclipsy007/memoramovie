...
<section class="py-24 md:py-32 px-6 bg-white" id="faq">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="text-center mt-12 pt-8 border-t border-memora-wine/10">
            ...
            <a href="mailto:hello@memoramovie.com" class="inline-flex items-center gap-2 text-memora-wine hover:text-memora-wineLight transition-colors text-sm uppercase tracking-widest">
