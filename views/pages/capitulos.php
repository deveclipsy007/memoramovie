<?php
/**
 * Capítulos Page - Memora Movie
 * Galeria de todos os capítulos/ocasiões
 */

$pageTitle = 'Galeria de Emoções - MEMORA MOVIE';
$pageDescription = 'Escolha o tema que melhor representa o seu momento.';
...
try {
    ...
    $chapters = [
        ['id' => 'love', 'title' => 'Love Story', 'subtitle' => 'Para casamentos, pedidos ou reconquistas.', 'color' => '#5A0B18'],
        ['id' => 'legacy', 'title' => 'The Legacy', 'subtitle' => 'A história dos seus pais ou avós.', 'color' => '#8B4513'],
        ['id' => 'newborn', 'title' => 'New Life', 'subtitle' => 'Do anúncio da gravidez ao primeiro ano.', 'color' => '#D4A5A5'],
        ['id' => 'travel', 'title' => 'Wanderlust', 'subtitle' => 'Aquela viagem que mudou quem você é.', 'color' => '#2C3E50'],
        ['id' => 'pet', 'title' => 'Soulmate', 'subtitle' => 'Uma homenagem ao seu melhor amigo.', 'color' => '#E67E22'],
        ['id' => 'friendship', 'title' => 'Best Years', 'subtitle' => 'Amizades que o tempo não apaga.', 'color' => '#9B59B6'],
    ];
}
...
<div class="pt-24 min-h-screen bg-memora-cream">
    ...
    <div class="py-12 text-center">
        <h1 class="font-serif text-5xl text-memora-wine mb-4">Galeria de Emoções</h1>
        <p class="text-memora-black/60">Escolha o tema que melhor representa o seu momento.</p>
    </div>
